...
public class APIClient {
    ...
    private Object sendRequest(String method, String uri, Object data)
        ...
        String auth = getAuthorizationHeader(this.user, this.password);
        ...
        if (method.equals("POST")) {
            ...
            if (data != null) {
                if (uri.startsWith("add_attachment"))   // add_attachment API requests
                {
                    ...
                    InputStream istreamFile;
                    istreamFile = new FileInputStream(uploadFile);
                    int bytesRead;
        ...
        if (status != 200) {
            ...
            if (istream == null) {
                throw new APIException(status, "(No additional error message received)");
            }
        } else {
        ...
        if ((istream != null)
            ...
            istream.close();
            res = data;
        } else {// Not an attachment received
     ...
     */
    public String getAuthorizationHeader(String user, String password) {
