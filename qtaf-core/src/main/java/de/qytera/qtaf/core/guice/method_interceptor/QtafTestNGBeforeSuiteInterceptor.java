 ...
 */
public class QtafTestNGBeforeSuiteInterceptor extends AbstractTestNGAnnotatedMethodInterceptor implements MethodInterceptor {
    private final PublishSubject<BeforeSuiteExecutionInfo> beforeStepExecution = QtafEvents.beforeTestSuite;
    private final PublishSubject<BeforeSuiteExecutionInfo> afterStepExecutionSuccess = QtafEvents.beforeTestSuiteSuccess;
    private final PublishSubject<BeforeSuiteExecutionInfo> afterStepExecutionFailure = QtafEvents.beforeTestSuiteFailure;
